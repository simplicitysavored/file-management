package xyz.yuanjin.project.folderlist.controller;
...
import xyz.yuanjin.project.folderlist.service.NasService;
...
public class HomeController {
    ...
    public String home(Model model) {
        ...
        model.addAttribute("listenDrivers", NasUtil.systemProperty().getNasListenFileList());
        return "home";
    }
